...
def retrain():
  def generate():
    ...
    class command():
      def __init__(self):
        ...
        self.how_many_training_steps = steps_text.get()
  ...
  # 種類確認ボタン
  btn3 = tk.Button(retrain, text='生成開始', command=generate)
  btn3.pack()
  btn3.place(x=20, y=50)

  pb = ttk.Progressbar(retrain, mode="indeterminate",length=200)
  pb.pack()
  pb.place(x=20, y=100)

  pb_label = tk.Label(retrain, text='待機中')
  pb_label.pack()
  pb_label.place(x=250, y=100)
